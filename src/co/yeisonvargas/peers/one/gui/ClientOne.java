 ...
 */
package co.yeisonvargas.peers.one.gui;

import co.yeisonvargas.peers.one.Facade;
import co.yeisonvargas.peers.one.UserInterface;
 ...
 */
public class ClientOne extends javax.swing.JFrame implements UserInterface {
    ...
    public ClientOne() {
        initComponents();
        try{
        this.serviceChat = new Facade(this, "localhost", 3233);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RMI Chat - Client 1");
    ...
    private void jButtonSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendActionPerformed
        ...
        System.out.println("Ok client One");
        System.out.println(this.serviceChat.sendMessageClientTwo(jTextAreaNewMessage.getText(), ""));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientOne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
